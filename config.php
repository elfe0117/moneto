...
define('G5_STORAGE_URL',    G5_URL.'/'.G5_STORAGE_DIR);
...
define('G5_STORAGE_PATH',   G5_PATH.'/'.G5_STORAGE_DIR);
...
define('G5_SESSION_PATH',   G5_STORAGE_PATH.'/'.G5_SESSION_DIR);
