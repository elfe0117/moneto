...
define('G5_MYSQL_USER', 'moneto');
define('G5_MYSQL_PASSWORD', 'Moneto12@!');
define('G5_MYSQL_DB', 'monetodb');
...
$g5['channel_table'] = G5_TABLE_PREFIX.'channel'; // 채널 정보 테이블
$g5['channel_host_table'] = G5_TABLE_PREFIX.'channel_host'; // 채널 호스트 정보 테이블
