...
if ((isset($wr_id) && $wr_id) || (isset($wr_seo_title) && $wr_seo_title)) {
    ...
    if (!get_session($ss_name))
    {
        ...
        if ($write['mb_id'] && $write['mb_id'] === $member['mb_id']) {
            ...
            insert_point($config['cn_id'], 'basic', $member['mb_id'], $board['bo_read_point'], ((G5_IS_MOBILE && $board['bo_mobile_subject']) ? $board['bo_mobile_subject'] : $board['bo_subject']).' '.$wr_id.' 글읽기', $bo_table, $wr_id, '읽기');
        }
