            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="td_category"><a href="<?php echo get_pretty_url($row['cn_id'], $row['bo_table']) ?>"><?php echo cut_str($row['bo_subject'], 20) ?></a></td>
                        <td><a href="<?php echo get_pretty_url($row['cn_id'], $row['bo_table'], $row2['wr_id']); ?><?php echo $comment_link ?>"><?php echo $comment ?><?php echo conv_subject($row2['wr_subject'], 100) ?></a></td>
                        <td class="td_mbname">
