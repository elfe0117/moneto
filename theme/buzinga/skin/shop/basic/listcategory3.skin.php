...
$sql = " select ca_id, ca_name from {$g5['g5_shop_category_table']} where cn_id = '{$config['cn_id']}' AND ca_id like '${depth2_ca_id}%' and length(ca_id) = 4 and ca_use = '1' order by ca_order, ca_id ";
