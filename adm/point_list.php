...
$sql_search = " WHERE po.cn_id = '{$config['cn_id']}' ";
...
<div class="local_ov01 local_ov">
    ...
    if (isset($mb['mb_id']) && $mb['mb_id']) {
        ...
        $row2 = sql_fetch(" select sum(po_point) as sum_point from {$g5['point_table']} WHERE cn_id = '{$config['cn_id']}' ");
        ...
        <table>
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col"><?php echo subject_sort_link('po_type') ?>유형</a></th>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_left"><?php echo(get_text($row['po_type'])); ?></td>
    ...
    <form name="fpointlist2" method="post" id="fpointlist2" action="./point_update.php" autocomplete="off">
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="row"><label for="po_type">유형<strong class="sound_only">필수</strong></label></th>
                        <td>
                            <select name="po_type">
                                <?php echo(option_selected('basic', $po_type, '기본 포인트')); ?>
                                <?php echo(option_selected('recommend', $po_type, '추천인 포인트')); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
